...
class Circle{
    ...
    public static Double distanceBetweenCircles(Circle a, Circle b){
        double distanceBetweenCenters = Point.distanceBetween(a.getOrigin(),b.getOrigin());
        double totalRadius = a.getRadius() + b.getRadius();
        return distanceBetweenCenters - totalRadius; 
        //FIXME
    	//return Point.distanceBetween(a.getOrigin(),b.getOrigin()) - a.getRadius() - b.getRadius();
    }
}